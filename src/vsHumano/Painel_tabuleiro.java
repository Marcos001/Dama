...
public class Painel_tabuleiro extends JPanel implements ActionListener{
    ...
    ImageIcon seta = new ImageIcon(getClass().getResource("../imagens/indicador.png"));
...
//linha 7
    ...
    public void mudar_label_jogador(){
        if(vez_de_jogar){
            ...
            jogador2_vez.setIcon(carregar);
        }
        else{
            jogador1_vez.setIcon(carregar);
